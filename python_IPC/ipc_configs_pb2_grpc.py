...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in ipc_configs_pb2_grpc.py depends on'
...
class image_transferServicer(object):
    """Missing associated documentation comment in .proto file."""
...
def add_image_transferServicer_to_server(servicer, server):
    rpc_method_handlers = {
    ...
    server.add_registered_method_handlers('image_transfer', rpc_method_handlers)


 # This class is part of an EXPERIMENTAL API.
class image_transfer(object):
    """Missing associated documentation comment in .proto file."""

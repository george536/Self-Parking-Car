...
class BEVCalibration(Thread):
    ...
    def run(self):
        ...
        sliders = [
            ...
            ("front_camera_left_indentation", config_modifications_insatnce.front_camera_left_indentation, config_modifications_insatnce.update_front_camera_left_indentation, -100, 100, 0.1),
            ("front_camera_top_indentation", config_modifications_insatnce.front_camera_top_indentation, config_modifications_insatnce.update_front_camera_top_indentation, -100, 100, 0.1),
            ...
            ("rear_camera_top_indentation", config_modifications_insatnce.rear_camera_top_indentation, config_modifications_insatnce.update_rear_camera_top_indentation, -100, 100, 0.1),
            ("left_camera_left_indentation", config_modifications_insatnce.left_camera_left_indentation, config_modifications_insatnce.update_left_camera_left_indentation, -100, 100, 0.1),

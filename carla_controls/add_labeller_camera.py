...
class LabellerCamera(CMD):
    ...
    This is used for parking spot labelling.
    """
    def __init__(self,world, camera_type="rgb", image_type=ColorConverter.Raw,
    ...
    def create_camera(self):
        """Returns camera object after being attached"""
